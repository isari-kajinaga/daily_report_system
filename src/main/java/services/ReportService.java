...
public class ReportService extends ServiceBase {
     ...
     * @return 一覧画面に表示するデータのリスト
     */
    public List<ReportView> getSearchPerPage(String employee, int page) {

        List<Report> reports = em.createNamedQuery(JpaConst.Q_REP_GET_ALL_SEARCH, Report.class)
    ...
    public long countAllSearch(String employee) {

        long count = (long) em.createNamedQuery(JpaConst.Q_REP_COUNT_ALL_SEARCH, Long.class)
                .setParameter(JpaConst.JPQL_PARM_EMPLOYEE, "%" + employee + "%")
                .getSingleResult();
