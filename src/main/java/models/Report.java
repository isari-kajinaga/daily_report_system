...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_REP_GET_ALL_SEARCH,
            query = JpaConst.Q_REP_GET_ALL_SEARCH_DEF),
    @NamedQuery(
            name = JpaConst.Q_REP_COUNT_ALL_SEARCH,
            query = JpaConst.Q_REP_COUNT_ALL_SEARCH_DEF)
})
